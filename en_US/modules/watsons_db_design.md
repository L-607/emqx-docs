...
The MySQL database provides data support for the SDES platform. The complete SQL statement for database table design is as follows, which can be directly imported and executed in the MySQL database.
